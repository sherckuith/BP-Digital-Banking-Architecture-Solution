...
*   **components/**: Diagramas de Nivel 3. Detallan la estructura interna de los contenedores clave (Transaction Service, Onboarding, Audit, Customer Service). Incluye diagramas de Secuencia.
